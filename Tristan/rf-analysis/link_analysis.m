...
sat_sband.eff_factor       = 0.7;             % percentage
...
sat_xband.eff_factor       = 0.7;               % percentage
sat_xband.ant_gain_ideal   = 14;                % dBi
sat_xband.tx_power         = 1;                 % Watt
sat_xband.loss_cables      = 0.3;               % dB
sat_xband.frequency        = 7.25e9;            % Hz     XBAND
sat_xband.datarate         = 120e6;              % Bps    FINE TUNE THIS ONE
